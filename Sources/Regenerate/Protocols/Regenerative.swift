...
public extension Regenerative {
    ...
    func contents(previousKey: Data? = nil, keys: Mapping<Data, Data> = Mapping<Data, Data>()) -> Mapping<String, Data> { return root.contents(previousKey: previousKey, keys: keys) }
    ...
    func capture(info: [String: Data], previousKey: Data? = nil, keys: Mapping<Data, Data> = Mapping<Data, Data>()) -> Self? {
    ...
    func capture(content: Data, previousKey: Data? = nil, keys: Mapping<Data, Data> = Mapping<Data, Data>()) -> (Self, Set<String>)? {
    ...
    func capture(content: Data, digestString: String, previousKey: Data? = nil, keys: Mapping<Data, Data> = Mapping<Data, Data>()) -> (Self, Set<String>)? {
    ...
    func capture(digestString: String, content: Data, at route: Path, previousKey: Data? = nil, keys: Mapping<Data, Data> = Mapping<Data, Data>()) -> (Self, Set<String>)? {
